...
Sessão (SESSION) é uma funcionalidade usada para o controle de acesso e outras informações que seja importantes enquanto o navegador estiver aberto com o site.
...
final class ControleDeAcesso
{
    ...
    {
        self::iniciarSessao();
        //Em certas páginas, se o usuário não for um admin, ele será 
