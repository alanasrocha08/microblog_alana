...
// aos dados da sessão em andamento e do uduário logado.
ControleDeAcesso::exigirLogin();
$usuarioServico = new UsuarioServico();

// Buscando os dados do usuário na SESSÃO a partir do id dele
...
if (isset($_POST["atualizar"])) {
	try {
		...
		/*Avaliando senha 
		Se o ccampo de senha estiver vazio, então vamos manter a mesma senha já existente no banco. Caso contrário, vamos repassar a senha digitado para verificação. */
